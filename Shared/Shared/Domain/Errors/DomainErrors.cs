...
public static class Errors
{
    public static class Domain
    {
        public static class String
        {
            ...
            public static ValidationError MaxLength(string repr, int maxLength, string identifier) => ValidationError.New($"${identifier} Maxlength is '{maxLength}' characters, but got '{repr.Length}'.");

            public static ValidationError MinLength(string repr, int minLength, string identifier) => ValidationError.New($"${identifier} Minlength is '{minLength}' characters, but got '{repr.Length}'.");
        }
