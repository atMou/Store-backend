...
public record PaymentStatus
{
    ...
    public static readonly PaymentStatus Processing =
        new(PaymentStatusCode.Processing, nameof(Processing), "PaymentInfo is being processed.");
    ...
    public static readonly PaymentStatus Cancelled =
        new(PaymentStatusCode.Cancelled, nameof(Cancelled), "PaymentInfo has been cancelled.");
    ...
    static PaymentStatus()
    {
        ...
        Pending.AllowedStatusChangeTo = [Processing, Authorized, Paid, Failed, Voided, Cancelled];
        Processing.AllowedStatusChangeTo = [Authorized, Paid, Failed, Voided, Cancelled];
        Authorized.AllowedStatusChangeTo = [Paid, Voided, Cancelled];
