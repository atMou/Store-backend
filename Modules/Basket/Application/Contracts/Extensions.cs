...
public static class Extensions
{
    public static CartResult ToResult(this Cart cart, IEnumerable<Coupon> coupons)
    {
        return new CartResult
        {
            ...
            DeliveryAddress = cart.DeliveryAddress.ToResult(),
    ...
    public static LineItemResult ToResult(this LineItem lineItem)
    {
        return new LineItemResult
        {
            ...
            ColorVariantId = lineItem.ColorVariantId.Value,
            SizeVariantId = lineItem.SizeVariantId,
            Slug = lineItem.Slug,
    ...
    private static IEnumerable<LineItemResult> ToResult(this IEnumerable<LineItem> lineItems)
    {
